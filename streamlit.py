...
if page == pages[1]:
    ...
    sns.heatmap(df_numerical.corr(), ax=ax)
    st.write(fig)
...
if page == pages[2]:
    ...
    def prediction(classifier):
        if classifier == 'Random Forest':
            clf = joblib.load("randomforestclf")
        elif classifier == 'SVC':
            clf = joblib.load("svcclf")
        elif classifier == 'Logistic Regression':
            clf = joblib.load("lrclf")
        elif classifier == 'XGBoost Classifier':
            clf = joblib.load("xgbclf")
        return clf
    ...
    choice = ['Random Forest', 'SVC', 'Logistic Regression', "XGBoost Classifier"]
